...
func _setup_event_connections() -> void:
	...
	Events.ballte_reward_exited.connect(_show_map)
	Events.campifre_exited.connect(_show_map)
...
func _on_battle_won() -> void:
	if map.floors_climbed == MapGenerator.FLOORS: #last floor, at boss room
		var win_screen := _change_view(WIN_SCREEN_SCENE) as WinScreen
		win_screen.character_stats = character
