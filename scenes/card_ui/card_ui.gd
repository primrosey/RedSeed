...
func _ready() -> void:
	Events.card_aim_started.connect(_on_card_drag_or_aiming_statrted)
	Events.card_drag_started.connect(_on_card_drag_or_aiming_statrted)
...
func request_tooltip() -> void:
	...
	Events.card_tooltip_requested.emit(global_position, updated_tooltip)
...
func _on_card_drag_or_aiming_statrted(used_card: CardUI) ->  void:
	if used_card == self:
		return
