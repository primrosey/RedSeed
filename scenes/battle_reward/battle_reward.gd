...
const CARD_REWARDS_SCENE = preload("res://scenes/ui/card_rewards.tscn")
const REWARD_BUTTON_SCENE = preload("res://scenes/ui/reward_button.tscn")
...
func add_gold_reward(amount: int) -> void:
	var gold_reward = REWARD_BUTTON_SCENE.instantiate() as RewardButton
...
func add_card_reward() -> void:
	var card_reward := REWARD_BUTTON_SCENE.instantiate() as RewardButton
...
func add_relic_reward(relic: Relic) -> void:
	var relic_reward := REWARD_BUTTON_SCENE.instantiate() as RewardButton
...
func _show_card_rewards() -> void:
	...
	var card_rewards := CARD_REWARDS_SCENE.instantiate() as CardRewards
...
func _on_back_button_pressed() -> void:
	Events.ballte_reward_exited.emit()
